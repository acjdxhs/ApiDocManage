...
public class InformationController {
    ...
    //通过商品类型id查询视频设备
    @RequestMapping(value = "/getVideoDeviceByGoodTypeID", method=RequestMethod.GET)
    @ResponseBody
    public Object getVideoDeviceByGoodTypeID(@RequestParam(value="good_type_id")int good_type_id){
        return informationService.getVideoDeviceByGoodTypeID(good_type_id);
    }
    ///}}}
    ...
    @RequestMapping(value = "/findOperationLogByGoodWithoutPage",method = RequestMethod.GET)
    @ResponseBody
    public Object findOperationLogByGoodWithoutPage(@RequestParam(value = "good_id",required = true)int good_id){
        return informationService.findOperationLogByGoodWithPage(good_id);
    }
